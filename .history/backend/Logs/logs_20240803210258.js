        ...
        <div class="table-container">
            <table>
                ...
                <tr>
                    ...
                    <th class="fixed-width">Category</th>
                    <th class="fixed-width">Duration in Hrs./Days</th>
                    <th class="wide-colum">Supervisor Name & Sign,AME Licence No</th>
                </tr>
            </thead>
                <tbody>
                    ${logs.map((log, index) => `
