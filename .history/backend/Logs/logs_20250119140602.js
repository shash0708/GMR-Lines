...
router.post('/createLog', fetchuser, async (req, res) => {
  try {
    const { Id, dateTime,Location,ATC, ACTtype, ACRegNo, TOM, CPU, FOT, SGH, RI, MEL, TS, MOD, REP, INSP, Training, Perform, Supervise, CRS_RTS, ATA, OP, DU, MRR, Supervisor } = req.body;
...
router.put('/updatenotes/:Id', fetchuser, async (req, res) => {
  try {
    ...
    const { Location,dateTime,ACType,ACRegNo, TOM, CPU, FOT, SGH, RI, MEL, TS, MOD, REP, INSP, Training, Perform, Supervise, CRS_RTS, ATA, OP, DU, MRR, Supervisor } = req.body;
