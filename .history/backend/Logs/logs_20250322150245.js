...
router.post('/createLog', fetchuser, async (req, res) => {
  try {
    nst { Id, dateTime,Location,ATC, ACTtype, ACRegNo, TOM, CPU, FOT, SGH, RI, MEL, TS, MOD, REP, INSP, Training, Perform, Supervise, CRS_RTS, ATA, OP, DU, MRR, Supervisor } = req.body;
