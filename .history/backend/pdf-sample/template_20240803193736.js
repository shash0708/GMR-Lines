        ...
        <table>
            <thead>
                ...
                <tr>
                    ...
                    <th class="fixed-width">Type od Aircraft/Engine</th>
                    <th class="fixed-width">Aircraft Reg.</th>
                    <th class="fixed-width">ATA Chapter</th>
                    <th class="fixed-width">Work Order No.</th>
                    <th class="wide-column" colspan="5">Maintenance Task</th><!-- Merge 5 columns for Date -->
            ...
            <tbody>
                <tr>
                    ...
                    <td class="fixed-width">{Mt}</td>
                    <td class="fixed-width">{TOM}/td>
                    <td class="wide-column" colspan="5">{TOA}</td> <!-- Merge 5 columns for Data 7 -->
