...
const Cards = () => {
  ...
  const { filteredLogs, searchTerm, setSearchTerm, selectedLogs, handleSelect } = useState;
 ...
 // Find full log objects from selected IDs

const handleExportPDF = async () => {
  if (selectedArray.length === 0) { // Check against selectedArray
      ...
      const htmlContent = `
          ...
          <body>
              <div class="table-container">
                  <table>
                      <tr>
                          <th colspan="5">Name<br>Ps<br>Ij</th>
                  ...
                  <table>
                      ...
                      <tbody>
                          ${selectedArray.map(log => `
                              <tr>
                                  <th class="fixed-width">${log.Date}</th>
