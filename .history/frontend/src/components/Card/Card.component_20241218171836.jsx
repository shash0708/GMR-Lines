    ...
    <div class="table-container">
        ...
        <table>
            <tr>
                ...
                <th class="fixed-width" colspan="3">VIII <br>Type of Maintenance activity</th>
            ...
            <tr>
                ...
                <th class="wide-column" colspan="3"> Operations Performed</th>
            ...
            <tbody>
                ...
                <tr> <th class="fixed-width">Date & Time</th>
                    ...
                    <th class="wide-column" colspan="3">${log.OP}</th>
                    <th>${log.DU}</th> 
                    <th >${log.MRR}</th>
