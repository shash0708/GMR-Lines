...
<head>
    ...
    <style>    
        ...
        .ata-column {
         ...
         .date-cell {
            width: 20px; /* Fixed width for the Date cell */
            font-size: 10px;
        }
        .empty-cell {
    ...
    <div class="table-container">
        ...
        <table>
            ...
            <tr>
                ...
                <th class="ata-column">Mainten<br>ance<br>Record<br>ref.</th>
                <th  class="ata-column">Supervisor<br>Name<br>AME<br> Licence No</th>
            </tr>
            <tbody>
