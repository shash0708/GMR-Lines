...
<head>
    ...
    <style>    
        ...
        .spa {
            ...
            /* Rotates the text by 180 degrees */\ /* Ensures the rotated text remains readable */
            text-align: center;
    ...
    <div class="table-container">
        ...
        <table>
            ...
            <tr>
                ...
                <th class="spa">MOD</th>
                <th class="spa">REP</th>
                <th class="spa">INSP</th>
                <th class="spa">Training</th>
                <th class="spa">Perform</th>
                <th class="spa">Supervise</th>
                <th class="spa">CRS/RTS</th>
