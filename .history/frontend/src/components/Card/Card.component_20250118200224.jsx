...
<head>
    ...
    <style>    
        ...
        .spa {
            width: 12px; /* Fixed width for the "spa" columns */
            text-align: center; /* Centers the text horizontally */
            font-size: 10px;
            vertical-align: middle; /* Aligns text vertically within the cell */
            white-space: nowrap; /* Prevents wrapping inside the column */
        }
        .spa span {
            display: inline-block; /* Ensures the text is treated as a block for rotation */
            transform: rotate(90deg); /* Rotates the text to the right */
            transform-origin: center; /* Ensures the rotation happens around the center of the text */
            line-height: 1; /* Adjusts the line height to make it compact */
        }
        .ata-column {
            width: 50px;
        }
    ...
    <div class="table-container">
        ...
        <table>
            ...
            <tr>
                ...
                <th>Maintenance<br>Record<br>ref.</th>
