...
<head>
    ...
    <style>    
     ...
     .spa {
    width: 12px; /* Compact column width */
    text-align: center;
    font-size: 10px;
...
.spa span {
    ...
    transform: rotate(90deg); /* Rotates content vertically */
    transform-origin: center;
    line-height: 1; /* Removes extra space within the rotated text */
    margin: 0; /* Ensures no margin for the rotated text */
    padding: 0; /* Ensures no padding for the rotated text */
}
