...
<head>
    ...
    <style>    
        ...
        .rotated-text {
            ...
            transform: rotate(180deg); /* Rotate the text by 270 degrees */
            transform-origin: center; /* Rotate around the center */
            writing-mode: vertical-rl; /* Optional: Vertical text layout */
        }
    ...
    <div class="table-container">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                                <th class="date-cell">${log.dateTime}</th>
                    ...
                    <th class="spa"><span class="rotated-text">${log.FOT}</span></th>
                    <th class="spa"><span class="rotated-text">${log.SGH}</span></th>
                    <th class="spa"><span class="rotated-text">${log.RI}</span></th>
                    <th class="spa"><span class="rotated-text">${log.MEL}</span></th>
                    <th class="spa"><span class="rotated-text">${log.TS}</span></th>
                    <th class="spa"><span class="rotated-text">${log.MOD}</span></th>
                    <th class="spa"><span class="rotated-text">${log.REP}</span></th>
                    <th class="spa"><span class="rotated-text">${log.INSP}</span></th>
                    <th class="spa"><span class="rotated-text">${log.Training}</span></th>
                    <th class="spa"><span class="rotated-text">${log.Perform}</span></th>
                    <th class="spa"><span class="rotated-text">${log.Supervise}</span></th>
                    <th class="spa"><span class="rotated-text">${log.CRS_RTS}</span></th>
