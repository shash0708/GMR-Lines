            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th class="fixed-width">${log.CPU}</th>
                         <td class="spa">${log.STC.FOT === "X" ? "X" : ""}</td>
                    <td class="spa">${log.SGH === "X" ? "X" : ""}</td>
                    <td class="spa">${log.RI === "X" ? "X" : ""}</td>
                    <td class="spa">${log.MEL === "X" ? "X" : ""}</td>
                    <td class="spa">${log.TS === "X" ? "X" : ""}</td>
                    <td class="spa">${log.MOD === "X" ? "X" : ""}</td>
                    <td class="spa">${log.REP === "X" ? "X" : ""}</td>
                    <td class="spa">${log.INSP === "X" ? "X" : ""}</td>
                    <td class="spa">${log.Training === "X" ? "X" : ""}</td>
                    <td class="spa">${log.Perform === "X" ? "X" : ""}</td>
                    <td class="spa">${log.Supervise === "X" ? "X" : ""}</td>
                    <td class="spa">${log.CRS_RTS === "X" ? "X" : ""}</td>
