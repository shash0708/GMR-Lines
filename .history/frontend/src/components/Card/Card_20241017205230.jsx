...
const Card = ({ date, id,ToA }) => {
  ...
  const handleCardClick = () => {
    ...
    console.log(`Card clicked: ${date}, ID: ${id}`);
  };
  ...
  <div class="icon-container">
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="plane-icon">
      <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 21.005L12 14.005L2.5 9.005L3 7.505L12 12.005L20.5 7.505L21 9.005L12 14.505L13.5 21.005L12 22.505L10.5 21.005z" />
    </svg>
  </div>

  <div class="info-container" onClick={handleCardClick}>
  <div>Date: {date}</div>
  <div>ID: {id}</div>
  </div>
