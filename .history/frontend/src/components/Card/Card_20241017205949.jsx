...
const Checkbox = styled.div`
  position: absolute; /* Position the checkbox absolutely within the card */
  top: 10px; /* Adjust according to your design */
  right: 10px; /* Adjust according to your design */
  width: 30px;
  height: 30px;
  border-radius: 50%;
  background-color: blue; /* Color of checkbox */
  display: flex;
  align-items: center;
  justify-content: center;
  color: white;
  font-weight: bold;
  visibility: ${props => (props.isChecked ? 'visible' : 'hidden')}; /* Control visibility */
`;
...
const Card = ({ date, id,ToA }) => {
  ...
  return (
    <>
       <StyledCard onClick={handleCardClick} onContextMenu={(e) => { e.preventDefault(); handleCardLongPress(); }}>
        <div className="icon-container">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="plane-icon">
            <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 21.005L12 14.005L2.5 9.005L3 7.505L12 12.005L20.5 7.505L21 9.005L12 14.505L13.5 21.005L12 22.505L10.5 21.005z" />
          </svg>
        </div>
