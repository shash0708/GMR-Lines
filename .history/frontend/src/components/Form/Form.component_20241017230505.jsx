              ...
              <Grid item xs={12} key={field}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    sx={{
                      '& .MuiSelect-select': {
                        color: 'gray', // Text color of the selected item
                        backgroundColor: 'white', // Background color of the Select component
                      },
                      ...
                      '& .MuiMenuItem-root': {
                        backgroundColor: 'white', // Background color of menu items
