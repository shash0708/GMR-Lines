...
const LogForm = ({ user }) => {
  ...
  return (
    ...
    >
      <Typography variant="h4" gutterBottom sx={{ color: 'Black', textAlign: 'center', display: 'flex', alignItems: 'center' }}>
        <ArrowForwardIcon sx={{ marginRight: 1 }} /> {/* Add the arrow icon with margin */}
        Add new Log
      </Typography>
