...
const LogForm = ({ user }) => {
  ...
  const handleDateChange = (newValue) => {
    const formattedDateTime = dayjs(newValue).format('DD-MM-YYYY HH:mm'); // Format the date-time
    setFormState((prevState) => ({
      ...prevState,
      DateTime: formattedDateTime, // Update the state with the formatted value
    }));
  };
