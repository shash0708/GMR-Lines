...
{!localStorage.getItem('token')?<form className="d-flex" >
      ...
      </form>: <Link onClick={hangleLogout} className='btn btn-primary'><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-person-square" viewBox="0 0 16 16">
