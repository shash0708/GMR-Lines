...
const Card = styled.div`
  ...
  @media (min-width: 768px) {
    flex-direction: column; // Stacks cards in a line-wise layout for tablet and above
    align-items: center; // Center align items in the card container
  }

  // Media query for mobile screens
  @media (max-width: 767px) {
    flex-direction: row; // Keeps cards side by side for mobile view
    flex-wrap: wrap; // Allow cards to wrap to the next line if they exceed the width
