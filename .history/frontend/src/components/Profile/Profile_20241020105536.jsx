    ...
    <div>
      ...
      <div className="profile-container">
        ...
        <div className="profile-options">
          ...
          <div className={`collapse-content ${activeSection === 'personal' ? 'expanded' : ''}`}>
          ...
          <div className={`collapse-content ${activeSection === 'contact' ? 'expanded' : ''}`}>
          ...
          <div className={`collapse-content ${activeSection === 'emergency' ? 'expanded' : ''}`}>
          ...
          <div className={`collapse-content ${activeSection === 'legal' ? 'expanded' : ''}`}>
