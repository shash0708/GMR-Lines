...
const Profile = () => {
  ...
  // Retrieve the logged-in user's AMENO from localStorage
  const ameno = localStorage.getItem('ameno');

  const handleEditClick = () => {
    // Simply navigate to the edit page without passing any URL params
    navigate('/edit');
  };
