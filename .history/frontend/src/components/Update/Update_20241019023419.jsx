...
const Logup = () => {
  return (
    <div>
      ...
      <p><strong>ACTtype:</strong> <p type="text" name="ACTtype" value={editableLog.ACTtype} onChange={handleInputChange} /></p>
  <p><strong>ACRegNo:</strong> <p type="text" name="ACRegNo" value={editableLog.ACRegNo} onChange={handleInputChange} /></p>
  <p><strong>TOM:</strong>  type="text" name="TOM" value={editableLog.TOM} onChange={handleInputChange} /></p>
  <p><strong>CPU:</strong>
