...
const Logup = () => {
  ...
  <p><strong>TOM:</strong> <p type="text" name="TOM" /></p>
 <strong>CPU:</strong><p>uhuh</p>
 
      </div>

      <div className="log-item">
      <p><strong>ACTtype:</strong> <p type="text" name="ACTtype"  /></p>

</div>
<div className="log-item">
<p><strong>ACRegNo:</strong> <p type="text" name="ACRegNo" /></p>

</div>
<div className="log-item">

</div><div className="log-item">
