        ...
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <div className="column">
              <p><strong>Location:</strong> {editableLog.Location}</p>
              <p><strong>ACTtype:</strong> {editableLog.ACTtype}</p>
              <p><strong>ACRegNo:</strong> {editableLog.ACRegNo}</p>
              <p><strong>TOM:</strong> {editableLog.TOM}</p>
