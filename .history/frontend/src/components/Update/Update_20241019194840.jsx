        ...
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <div className="column">
              ...
              <p><strong>CRS_RTS:</strong> <p/> {editableLog.CRS_RTS}</p>
            </div>

            {/* Fourth Column */}
            <div className="column">
              <p><strong>ATA:</strong><p/>  {editableLog.ATA}</p>
              <p><strong>OP:</strong><p/>  {editableLog.OP}</p>
              <p><strong>DU:</strong><p/>  {editableLog.DU}</p>
              <p><strong>MRR:</strong><p/>  {editableLog.MRR}</p>
              <p><strong>Supervisor:</strong><p/>  {editableLog.Supervisor}</p>
            </div>
