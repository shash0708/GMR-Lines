...
const ChatWindow = () => {
    ...
    try {
      ...
      const response = await fetch(`${URL}/logs/createLog`, {
        ...
        headers: {
          ...
          "auth-token": localStorage.getItem("auth-token"), // Assuming you store the token in localStorage
        },
      ...
      if (response.ok) {
        ...
        window.location.href = "/"; // Redirect to past records page
      } else {
  ...
  return (
    <div className="chat-container">
      <Topbar dateTime={dateTime} onDateChange={handleDateChange} />
      ...
      {!isComplete ? (
        <div className="input-container">
          ...
          />
          <button onClick={handleSendMessage}><RiSendPlaneFill />
          </button>
        </div>
      ) : (
